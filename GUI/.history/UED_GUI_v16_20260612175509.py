...
def initialize_NI6251():
    ...
    nd_task = nd.Task()
    try:
        nd_task.ai_channels.add_ai_voltage_chan(f"{DEVICE}/{AI_CHANNEL}", terminal_config=TerminalConfiguration.DIFF, min_val=-10.0, max_val=10.0)
        ...
        nd_task.timing.cfg_samp_clk_timing(rate=NI6251_RATE, source=CLOCK_TERMINAL,
