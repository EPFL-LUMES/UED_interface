...
path = r'G:\UED_measurements\2025\12 December\10\r000046\RAW'   # e.g. r'D:\UED_measurements\2025\11 November\25\r000040\RAW'
...
file_list = sorted(glob.glob(os.path.join(path, 'data', '*.h5')))
